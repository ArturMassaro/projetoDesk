...
public class EditUser extends javax.swing.JFrame {
    ...
    public EditUser(int i) {
        ...
        mUser = mController.getUser(id);
        edNome.setText(mUser.getName());
        edSenha.setText(mUser.getPassword());
        edUser.setText(mUser.getPassword());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        User u = new User(nome, user, senha);
        
       
        
        mController.editUser(u, id);
