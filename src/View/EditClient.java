...
public class EditClient extends javax.swing.JFrame {
    ...
    public EditClient(int i) {
        id = i;
        initComponents();
        mController = new ClientController();

        mClient = mController.getClient(id);
        
        edFirstName.setText(mClient.getFirstName());
        edLastName.setText(mClient.getLastName());
        edEmail.setText(mClient.getEmail());
        edTelefone.setText(mClient.getPhone());
        edEndereco.setText(mClient.getAddress());
    }
    ...
    private void initComponents() {
        ...
        edFirstName.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                edFirstNameActionPerformed(evt);
            }
        });
        ...
        edLastName.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                edLastNameActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(edEmail, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(edFirstName, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addComponent(jLabel1))
                                .addGroup(layout.createSequentialGroup()
                                    .addComponent(jLabel3, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                    .addComponent(edEndereco, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGap(18, 18, 18)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(edTelefone, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(edLastName, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void edFirstNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_edFirstNameActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_edFirstNameActionPerformed
    ...
    private void edLastNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_edLastNameActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_edLastNameActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String firstName, lastName, email, phone,adress;
        firstName = edFirstName.getText();
        lastName = edLastName.getText();
        email = edEmail.getText();
        phone = edTelefone.getText();
        adress = edEndereco.getText();
        
        Client cli = new Client(firstName, lastName, adress,phone,email);
        mController.editClient(cli,id);
